...
// if we are at the end of the string	
	...
	else if(fstcharLC =="t" && seccharLC =="i"  && thirdcharLC =="o"  && fourthcharLC =="n")		//4	//tion				
	{	
		concatstr = concatstr.substring(0, concatstr.length-prValLen);
		if (myString[i] == fstcharLC)
		{
	...
	else if(fstcharLC =="e" && seccharLC =="i"  && thirdcharLC =="n"  && (/[bcdfghjklmnpqrstvwx]/.test(fourthcharLC)))	//4 //special						
	{	
		if (myString[i] == fstcharLC)
		{
			replchar = "@";
	...
	else if(fstcharLC =="o" && seccharLC =="i"  && thirdcharLC =="n"  && (/[bcdfghjklmnpqrstvwx]/.test(fourthcharLC)))	//4	//special					
	{	
		if (myString[i] == fstcharLC)
		{
			replchar = "ū-ā";
	...
	else if(fstcharLC =="a" && seccharLC =="m"  && (/[bcdfghjklmnpqrstvwx]/.test(thirdcharLC)))	//3	// special				
	{	
		if (myString[i] == fstcharLC)
		{
			replchar = "@";
	...
	else if(fstcharLC =="a" && seccharLC =="n"  && (/[bcdfghjklmnpqrstvwx]/.test(thirdcharLC)))	//3 //special			
	{	
		if (myString[i] == fstcharLC)
		{
			replchar = "ö";
	...
	else if(fstcharLC =="c" && seccharLC =="c"  && (/[aoubcdfghjklmnpqrstvwx]/.test(thirdcharLC)))	//3					
	{	
		if (myString[i] == fstcharLC)
		{
			replchar = "k";
	...
	else if(fstcharLC =="c" && seccharLC =="c"  && (/[eiy]/.test(thirdcharLC)))	//3					
	{	
		if (myString[i] == fstcharLC)
		{
			replchar = "k-s";
	...
	// Ekalipi Consonants
		...
		{
			replchar = "s"; //changed from g to s 
