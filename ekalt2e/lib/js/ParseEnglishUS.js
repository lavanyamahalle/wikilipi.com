		...
		function ParseEnglishUS(ipaParse){        
			...
			for(i = 0; i < myString.length; i++) {                                      
				EkaTTSParseEnglishUS(i, myString);
			}
	    }
        ...
        function EkaTTSParseEnglishUS(i,myString) {
					currchar = myString[i] ;
					skipchar = "n";
			...
			// ipa vowels
				...
				if (myString[i] == String.fromCharCode(652)){
					...
					else if(myString[i] == String.fromCharCode(198)){
					currchar = myString[i];
					ccVal ="@";			//Æ      latin capital letter Æ
					currtype="v";
					}
					...
					currchar = myString[i];
					ccVal ="a";			//ə        	latin small letter schwa
					currtype="v";
					} 
