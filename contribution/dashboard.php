...
{ 
window.location="https://wikilipi.com/contribution/dashboard.php";
}
</script>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                        <div class="collapse navbar-collapse">
						  ...
						  <li class="active" style="font-size:16px"><a href="http://wikilipi.com/view/dictionary.php"target="_blank">Dictionary</a></li>
							...
							<li style="font-size:16px"><a href="http://wikilipi.com/contribution/dashboard.php" target="_blank">AdminApprovals</a></li>
                            </ul>
                        </div>
                        <!--/.nav-collapse -->
                    </div>
        ...
        <div class='row' style='margin-top:50px;'>
            <div class='col-md-12'>
                <div class="text-center"><span>
                        <font face="Arial" size="6">Approvals</font><span></div>
                        <div>
                            <input type="radio" id="pending" name="status" value="pending" onchange="handlePending()" checked>
                                <label for="male">Pending</label><br>
                                <input type="radio" id="Approved" name="status" value="Approved" onchange="handleApproved()">
                                <label for="female">Approved</label><br>
                        </div>
                <br>
