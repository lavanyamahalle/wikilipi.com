var concatstr = "";
function ParseMalayalam(sentWordforIPA)
{
...
function ParseMalayalamsAfterReplace(ipaParse)
{        
    ...
    {                                      
        EkaTTSParseMalayalam(i, myString);
    }
}
function EkaTTSParseMalayalam(i,myString) 
{
    currchar = myString[i] ;
