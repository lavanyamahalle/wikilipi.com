...
function EkaTTSParseWiki(i,myString) 
{
	...
	{       // ʊlatin small letter upsilon
		...
		if (currchar == String.fromCharCode(600)) 
		{    // ɘ	latin small letter reversed e
			concatstr = concatstr.substring(0, concatstr.length-ccValLen);
			ccVal = "o";	
		} 
		if (currchar == String.fromCharCode(601)) 
		{    // ɘ	latin small letter schwa
			concatstr = concatstr.substring(0, concatstr.length-ccValLen);
			ccVal = "o";	
		} 
		if (currchar == String.fromCharCode(111))
