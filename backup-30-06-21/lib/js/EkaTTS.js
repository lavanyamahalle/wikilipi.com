...
function EkaTTSMain(text) {
  if (text) {
    var myString = text;
  } else {
    var myString = $("#output-div").text().trim();
    // var myString = document.getElementById("output-div").value;
  }

  inplen = myString.length;
  console.log("Entered String is:" + myString);
  console.log("\nEntered String length is:" + inplen);
  ...
  console.log("final playlist ", ekalist);
  chain(ekalist[0]);
}
    ...
    if (result == true) {
      ...
      var mySound1 = soundManager.createSound({
        ...
        onload: function () {
          ...
          // console.log('Onload playing ',"eka"+i);
          // this.play();
        },
      });

      // console.log('Created Sound ',"eka"+i,'\n################\n');
    } else {
...
function EkaTTSParse(i, myString) {
  ...
  // More keyboard special characters
    ...
    //console.log("\nYou entered String is " + myString[i]);
  ...
  // An unexpected character was entered
    ...
    console.log(
      "\nYou entered Character at Position " + i + " is " + myString[i]
    );
    console.log(
      "<br /> It is neither an Ekalipi consonant,vowel or special allowed symbol. SKIPPED"
    );
    currchar = "u";
  }
...
var chain = function (idstring) {
  console.log("playing idstring ", idstring);
  soundManager.play(idstring, {
    ...
    onfinish: function () {
      ...
      soundManager.destroySound(idstring);
    },
  });
};
