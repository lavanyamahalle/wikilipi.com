                                                ...
                                                function EkaTTSMain(argument) {
													if(argument!=undefined){
														var myString = argument;
													}else{
                                                ...
                                                function EkaTTSConcatCreate(i, inplen, currtype, ccVal) {
                                                	...
                                                	if (i == inplen - 1) {
                                                		if (concatstr !== "") {
                                                			console.log("</br>concat string is " + concatstr + "\n</br>");
                                                			//Bump up the eka id by 1 so that we do not create a duplicate. A duplicate id puts the chain function in an infinite loop.							
                                                ...
                                                function EkaTTSParse(i, myString) {
                                                	...
                                                	// need to use double \\ instead of a single \
                                                	else if (myString[i] == "\\") {
                                                		currchar = myString[i];
                                                		ccVal = "$";
                                                		currtype = "v";
