				...
				<div class="row">
					<div class="col-xs-3 col-sm-3 col-lg-3 col-md-3" >
						<font face="Verdana" size="4">
							<textarea rows="2" cols="33" style="border:2px solid black; margin : 2px;"><?php
...
?></textarea>
				...
				<div class="row">
					<div class="col-xs-3 col-sm-3 col-lg-3 col-md-3" >
						<font face="Verdana" size="4">
							<textarea id="search_field" name="ipaOut" contenteditable="true" rows="2.5" cols="32"  style="border:2px solid green; margin : 2px;"><?php
...
$elements = explode(" ", $C_ENGLISH_save);

for ($i = 0; $i < count($elements); $i++) {

$sql1 = "SELECT * FROM EKA_MISSING_WORD_TABLE WHERE C_ENGLISH='$elements[$i]'";
...
if (mysqli_num_rows($result) > 0) 
 {
	...
	{
		echo $row['C_EKALIPI'] ."[". $row['C_COUNTRY'] ."]";
		echo " OR ";
	}
	echo " ";
 }
