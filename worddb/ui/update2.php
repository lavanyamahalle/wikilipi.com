...
$sql = "SELECT * FROM EKA_MISSING_WORD_TABLE1 WHERE srn = " . $srn;
...
$sql2 = "UPDATE EKA_MISSING_WORD_TABLE1 SET `C_ENGLISH` =  '$C_ENGLISH_save', `C_COUNT` =  '$inc_count', `C_EKALIPI` =  '$C_EKALIPI_save', `C_COUNTRY` =  '$C_COUNTRY_save', `C_OTHER` =  '$C_OTHER_save' WHERE srn ='$srn'";
...
// if ekalipi name is already in production table, delete row from missing table	
	{
		$sql2 = "DELETE FROM `EKA_MISSING_WORD_TABLE1` WHERE srn ='$srn'"; 
		$result3 = mysqli_query($conn2, $sql2);
...
{	
$sql2 = "UPDATE EKA_MISSING_WORD_TABLE1 SET `C_COUNT` =  '$C_COUNT_save', `C_EKALIPI` =  '$C_EKALIPI_save', `C_COUNTRY` =  '$C_COUNTRY_save', `C_OTHER` =  '$C_OTHER_save' WHERE srn ='$srn'";
...
<table>
    ...
    <div class="form-group">
      ...
      <td><input type="text" class="form-control" id="other" name="other" value="<?php echo $C_OTHER ?>" ></td>
    </div>
	</tr>
	<tr>
    <div class="form-group">
...
<tr>
				...
				<?php
                            	...
                            	$sql = "SELECT * FROM EKA_MISSING_WORD_TABLE1";
                     		...
                     		$result1 = mysqli_query($conn2, $sql);
                                ...
                                while($test=mysqli_fetch_array($result1))
                                {
									...
									echo"<td><font color='black'>".$test['UNIXTIME']."</font></td>";
