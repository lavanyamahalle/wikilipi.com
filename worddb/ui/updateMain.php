...
//$srn=776;
$isUpdated = 0;
$sql = "SELECT * FROM EKA_WORD_TABLE WHERE srn = " . $srn;
...
$sql2 = "UPDATE EKA_WORD_TABLE SET `C_ENGLISH` =  '$C_ENGLISH_save', `C_COUNT` =  '$inc_count', `C_EKALIPI` =  '$C_EKALIPI_save', `C_COUNTRY` =  '$C_COUNTRY_save', `C_OTHER` =  '$C_OTHER_save' WHERE srn ='$srn'";
...
{	
$sql2 = "UPDATE EKA_WORD_TABLE SET `C_ENGLISH` =  '$C_ENGLISH_save', `C_COUNT` =  '$C_COUNT_save', `C_EKALIPI` =  '$C_EKALIPI_save', `C_COUNTRY` =  '$C_COUNTRY_save', `C_OTHER` =  '$C_OTHER_save' WHERE srn ='$srn'";
...
<tr>
				...
				<?php
                            	...
                            	$sql = "SELECT * FROM EKA_WORD_TABLE";
                     		...
                     		$result1 = mysqli_query($conn, $sql);
                                ...
                                {
                                	$srn = $test['srn'];	
                                	$timestamp = strtotime($test['C_OTHER']);
									...
									echo"<td><font color='black'>".date("Y-m-d", $timestamp)."</font></td>";
