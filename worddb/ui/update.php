...
$sql1 = "SELECT * FROM $tableName WHERE C_ENGLISH='$C_ENGLISH'";
...
if (mysqli_num_rows($result1) > 0) 
 ...
 $match_val =0;
	...
	while($row = mysqli_fetch_assoc($result1))
	{
		...
		if($row['C_EKALIPI']==$C_EKALIPI_save)
		{
...
$sql2 = "UPDATE $tableName SET `C_ENGLISH` =  '$C_ENGLISH_save', `C_COUNT` =  '$inc_count', `C_EKALIPI` =  '$C_EKALIPI_save', `C_COUNTRY` =  '$C_COUNTRY_save', `C_OTHER` =  '$C_OTHER_save' WHERE srn ='$srn'";
...
{	
$sql2 = "UPDATE $tableName SET `C_ENGLISH` =  '$C_ENGLISH_save', `C_COUNT` =  '$C_COUNT_save', `C_EKALIPI` =  '$C_EKALIPI_save', `C_COUNTRY` =  '$C_COUNTRY_save', `C_OTHER` =  '$C_OTHER_save' WHERE srn ='$srn'";
